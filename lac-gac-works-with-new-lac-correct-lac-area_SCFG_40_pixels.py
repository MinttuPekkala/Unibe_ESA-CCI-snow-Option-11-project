        ...
        for sat, file_paths in sats.items():
            ...
            for file_path in file_paths:
                ...
                if da_type == 'lac':
                    ...
                    # SCFG raster is north-to-south but lat coordinate is south-to-north
                    ...
                    #print("scfg shape:", lac_ds.scfg.shape)

                    #print("LAC file:", file_path)
                    #print("Original LAC scfg values:")
                    #print(np.unique(lac_ds.scfg.values))
                    ...
                    for loc, coords in sel_area.items():
                        ...
                        #print("SCFG:", lac_crop.scfg.min().values, lac_crop.scfv.max().values)
